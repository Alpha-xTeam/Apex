    ...
    <section id="about" className="z-section z-about">
      <div className="z-about-inner">
        <div className="z-tag-row" data-reveal>
          <span className="z-tag">من نحن</span>
        </div>

        <h2 className="z-about-title" data-reveal data-reveal-delay="100">
          نُمكّن المتدربين من مواجهة تحديات الأمن السيبراني الحقيقية عبر بيئات محاكاة كاملة، يُولّدها الذكاء الاصطناعي ويتولاها خبراء بشريون.
        </h2>

        <p className="z-about-desc" data-reveal data-reveal-delay="200">
          منصتنا ليست مكاناً للتعلم النظري. هي ساحة تدريب حيّة، تتحدى فيها فرقاً افتراضية، تواجه سيناريوهات حقيقية، وتخرج منها بخبرة ميدانية يصعب اكتسابها لسنوات.
        </p>

        <div className="z-about-actions" data-reveal data-reveal-delay="300">
          <div className="z-about-social">
            <span className="z-about-social-label">تابعنا</span>
            {SOCIALS.map((s) => (
              <a
                key={s.label}
                href={s.href}
          ...
          <a
            ...
            className="z-btn z-btn-light z-btn-pill"
          >
            اعرف المزيد
          </a>
        </div>
        ...
        <div className="z-team-credit" data-reveal data-reveal-delay="400">
          <span className="z-team-credit-label">صُنع بحب من قبل</span>
          <div className="z-team-credit-card">
            <img
              src="/ALPHA-LOGO.png"
              alt="Alpha Team"
              className="z-team-credit-logo"
            />
            <div className="z-team-credit-info">
              <span className="z-team-credit-name">Alpha Team</span>
              <span className="z-team-credit-tagline">نبني حلولاً تقنية بجرأة</span>
            </div>
        ...
        <div className="z-globe-card" data-reveal data-reveal-delay="500">
          ...
          <div className="z-globe-content">
            <h3 className="z-globe-title">فرق افتراضية من ١٢ دولة حول العالم</h3>
            <p className="z-globe-desc">
              يعمل معك متدربون افتراضيون من ثقافات ومستويات متنوعة، يتفاعلون ويتحدون قراراتك لتدريبك على التواصل في بيئات عمل دولية حقيقية.
            </p>
          </div>
        </div>
      </div>
