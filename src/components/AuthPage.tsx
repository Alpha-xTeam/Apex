      ...
      <div className="auth-shell">
        <div className="auth-visual" aria-hidden="true">
          ...
          <div className="auth-social">
            <button className="auth-social-btn" type="button" onClick={() => supabase.auth.signInWithOAuth({ provider: 'google' })}>
            ...
            <button className="auth-social-btn" type="button" onClick={() => supabase.auth.signInWithOAuth({ provider: 'github' })}>
